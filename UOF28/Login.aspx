...
<body>
    ...
    <form id="form1" runat="server" class="ui large form" defaultbutton="btnSubmit">
                                    ...
                                    <div id="loginSegment">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"  >
                                            <ContentTemplate>
                                                ...
                                                <div class="required field" runat="server" visible="false" id="CaptchaArea" >
                                                    <div class="ui left icon input" style="align-items:center;">
                                                        <i class="lock icon"></i>
                                                        <asp:TextBox ID="txtCaptcha" style="width:150px;" MaxLength="4" ValidationGroup="login" runat="server"
                                                            meta:resourcekey="capTXTResource1" TabIndex="3" placeHolder="驗證碼" autocomplete="off"></asp:TextBox>                                                        
                                                        <img ID="captchaImage" runat="server" style="width:100px;align-items:center;border-left-width:10px" alt="Captcha" src="Login/Captcha.aspx" />
                                                        <Button runat="server" ID="captchaRefresh"  class="large ui circular label" style="width:25px;align-items:center;text-align:right;cursor: pointer"  onclick =" refreshCaptcha();return false;"  >
                                                          <i class="sync icon"></i>
                                                        </Button>                                                        
                                                    </div>
                                                </div>
                                                ...
                                                <div class="field">
                                                    <asp:Button ID="btnSubmit" CssClass="ui fluid large submit button" runat="server"
                                                        ...
                                                        Text="登入" TabIndex="5" EnableTheming="false" CausesValidation="true"
                                                ...
                                                <div class="ui error message login">
                                                    ...
                                                    <div>
                                                        <asp:RequiredFieldValidator ID="rvalidCaptcha" runat="server" Display="Dynamic" ControlToValidate="txtCaptcha" SetFocusOnError="true" Visible="false"
                                                            ValidationGroup="login" ErrorMessage="請輸入驗證碼" EnableTheming="false" meta:resourcekey="rvalidCaptchaResource1"></asp:RequiredFieldValidator>
                                                    </div>         
                                                     <div>
                                                        <asp:CustomValidator ID="cvCaptchaError" runat="server" Display="Dynamic" EnableTheming="false" ErrorMessage="驗證碼不正確" Visible="false"
                                                            ValidationGroup="login" OnServerValidate="cvCaptchaError_ServerValidate" meta:resourcekey="cvCaptchaErrorResource1"></asp:CustomValidator>
                                                    </div>
                                                    <div>
                                        ...
                                        <ContentTemplate>
                                            <div id="LogingWait" style="margin: 0 auto 0 auto; text-align: center; display: none">
                                                ...
                                                <div style="display: inline-block;">
                                                    <asp:Button ID="btnLogout" CssClass="ui fluid large submit button" runat="server"
                                                        OnClick="btnLogout_Click" Text="登出" EnableTheming="false"
                                                        Visible="false" meta:resourcekey="btnLogoutResource1">
                                                    </asp:Button>    
                                                </div>
                                            </div>
                                            </div>
                    ...
                    <ContentTemplate>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="color: blue">
                                    <asp:Literal ID="literalDesc" runat="server" Text="請輸入您的帳號，我們將寄出認證碼給您，如果您是使用AD驗證登入，請聯絡AD管理員取得新密碼"></asp:Literal></td>
                            </tr>
                        </table>
                    </ContentTemplate>
                    <Triggers>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <div class="ui error message forget">
                                    ...
                                    <asp:CustomValidator ID="cvAccountFail" runat="server" Display="Dynamic" ValidationGroup="forget" EnableTheming="false" ErrorMessage="帳號錯誤，請重新輸入"></asp:CustomValidator>
        ...
        <script>
            ...
            Sys.Application.add_load(function () {
                ...
                //後端註冊JS Function，會先跑ShowDownloadComplete才回來add_load，如從下載頁導頁過來的，把元件加入樣式後就可以return了
                if ($uof.tool.htmlDecode('<%=System.Web.Security.AntiXss.AntiXssEncoder.HtmlEncode(hfIsDownloadComplete.Value,true)%>') === '1') {
            ...
            function refreshCaptcha() {
                ...
                captchaImage.src = 'Login/Captcha.aspx?rand=' + Math.random(); // 加上隨機參數避免快取
            }
        ...
        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
            <ContentTemplate>
                ...
                <asp:Label ID="lblshowCaptchaMsg" runat="server" meta:resourcekey="lblshowCaptchaMsgResource1" Text="驗證碼(不分大小寫)" Visible="false"></asp:Label>
                ...
                <asp:Label ID="Label3" runat="server" Text="系統操作逾時或權限不足,請重新登入系統!!" Visible="False" meta:resourcekey="Label3Resource1"></asp:Label>
                ...
                <asp:Label ID="lblDownloadCompleteTip" runat="server" Text="下載完成後請點按【登出】" Visible="False" meta:resourcekey="lblDownloadCompleteTipResource1"></asp:Label>
                <asp:Label ID="lockedUserMsg" runat="server" Text="您的帳號已被鎖定" Visible="False" meta:resourcekey="lockedUserMsgResource1"></asp:Label>
                <asp:Label ID="overdueUserMsg" runat="server" Text="您的帳號已過期" Visible="False" meta:resourcekey="overdueUserMsgResource1"></asp:Label>
                <asp:Label ID="suspendedUserMsg" runat="server" Text="您的帳號已被停用" Visible="False" meta:resourcekey="suspendedUserMsgResource1"></asp:Label>
                ...
                <asp:Label ID="cvalidLoginMsg" runat="server" Text="帳號或密碼錯誤。<br/>若使用AD驗證，帳號輸入格式為：AD Domain\Account，例：ABC\admin" Visible="False" meta:resourcekey="cvalidLoginMsgResource1"></asp:Label>
                <asp:Label ID="cvalidLoginForDomainMsg" runat="server" Text="帳號或密碼錯誤。" Visible="False" meta:resourcekey="cvalidLoginForDomainMsgResource1"></asp:Label>
                <asp:Label ID="cvalidnotAllowLoginMsg" runat="server" Text="權限不足，請洽系統管理員" Visible="False" meta:resourcekey="cvalidnotAllowLoginMsgResource1"></asp:Label>
                ...
                <%--經討論後，把IP登出的提示文字改成統一(不在可登入範圍內)--%>
                <asp:Label ID="lblIPRangeErrorMsg" runat="server" Text="使用的IP不在可登入範圍內" Visible="false" meta:resourcekey="lblIPRangeErrorMsgResource1"></asp:Label>
                <asp:Label ID="lblIPNotInRangeByKick" runat="server" Text="使用的IP不在可登入範圍內" Visible="false" meta:resourcekey="lblIPRangeErrorMsgResource1"></asp:Label>
                ...
                <asp:HiddenField ID="hfIsDownloadComplete" runat="server" Value="0" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
</body>
