                                                    ...
                                                    <td style="padding-left: 20px;">
                                                        ...
                                                        <asp:Panel runat="server" ID="panelAfterTransMail" style="padding-left: 13px;display: flex;" meta:resourcekey="panelAfterTransMailResource1">
                                                            ...
                                                            <asp:Panel runat="server" ID="panelAfterTransMailMode" style="padding-left: 10px;" meta:resourcekey="panelAfterTransMailModeResource1">
                                                                <asp:RadioButton runat="server" ID="rbAfterTransMailModeSave" GroupName="rbgAfterTransMailMode" Text="保留私人訊息，並標示為" AutoPostBack="True" OnCheckedChanged="rbAfterTransMailModeSave_CheckedChanged" meta:resourcekey="rbAfterTransMailModeSaveResource1" />
                                    ...
                                    <asp:Panel ID="panEmpl" runat="server" meta:resourcekey="panEmplResource1">
                                        ...
                                        <tr>
                                            <td style="text-align: left">
                                                ...
                                                <Fast:Grid ID="Grid1" runat="server" DataKeyNames="FAVORITE_GUID" AllowPaging="true"
                                                    AllowSorting="True" AutoGenerateCheckBoxColumn="True" AutoGenerateColumns="False"
                                                    Width="100%"
                                                    OnRowDataBound="Grid1_RowDataBound" DataSourceID="odsFavoUserSet" DataKeyOnClientWithCheckBox="False" 
                                                    meta:resourcekey="Grid1Resource1"  DefaultSortDirection="Ascending" EmptyDataText="沒有資料" 
                                                    EnhancePager="True" KeepSelectedRows="False" PageSize="5" CustomDropDownListPage="False" 
