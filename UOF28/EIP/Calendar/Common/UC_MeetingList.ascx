    ...
    function bar2_Click(sender, args) {
        ...
        if (Key == "delete") {
            ...
            if (guids == "") {
                ...
                $uof.dialog.open2("~/EIP/Calendar/Common/ExportProgress.aspx", args.get_item(), '<%=lblDialogTitle.Text %>', 400, 200, openDialogResult, { "userID": '<%=lbUserGuid.Text%>', "hideClientID": '<%=hideMeetingIDs.ClientID %>' });                
            }            
        }
    }
...
<asp:Label ID="lblDialogTitle" runat="server" Text="匯出Excel" Visible="False" meta:resourcekey="lblDialogTitleResource1"></asp:Label>
