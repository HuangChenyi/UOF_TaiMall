...
<script type="text/javascript">
    ...
    function cvPlantChanged(source, arguments) {
        var isAudit = $('#<%=hfIsAudit.ClientID%>');
    if (isAudit.val()) {
            var plantGuid = $('#<%=hfPlantGuid.ClientID%>');
            if (plantGuid.val() == '') {
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table style="width:97%">
            ...
            <tr>
                <td style="padding-left:17px;">
                    <asp:CustomValidator ID="cvPlantChanged" runat="server" ForeColor="Red" ErrorMessage="設備已被異動, 請洽設備管理員" Display="Dynamic" meta:resourcekey="cvPlantChangedResource1" ClientValidationFunction="cvPlantChanged"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td style="padding-left:17px;">
...
<asp:Label ID="lblNoClass" runat="server" Text="無法對應類別" ForeColor="Red" Visible="False" meta:resourcekey="lblNoClassResource1"></asp:Label>
<asp:Label ID="lblNoPlant" runat="server" Text="設備已被刪除" ForeColor="Red" Visible="False" meta:resourcekey="lblNoPlantResource1"></asp:Label>
