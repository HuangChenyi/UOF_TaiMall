    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.IsAuthenticated)
        {
			...
			if (doLogout == "doLogout") {
                ...
                FormsAuthenticationTicket ticket = new FormsAuthenticationTicket(claimsIdentity.Name, true, 1);
				...
				if (isMNext != "Y")
				{
					...
					{
						Response.Cookies.Add(new HttpCookie("UOFOpenIdAccount", encTicket));
