...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="PdfSetting">
        <table style="width: 70%; text-align: left; margin: 0 auto" class="tab">
                ...
                <td colspan="2" style="background-color: #ffffff;width: 50%">
                    ...
                    <div id="txtSetting">
                        <table cellpadding="1" cellspacing="1" style="height: 100%" class="tab2">
                            ...
                            <tr>
                                <td style="background-color: #cccccc" align="right">
                                    <asp:Label runat="server" Text="不透明度：" ID="Label14"
                ...
                <td style="background-color: #ffffff;width: 50%" colspan="2">
                    <div id="txtSetting2">
                        <table cellpadding="1" cellspacing="1" style="height: 100%" class="tab2">
                            ...
                            <tr>
                                <td style="background-color: #cccccc" align="right">
                                    <asp:Label runat="server" Text="不透明度：" ID="Label15"
                ...
                <td colspan="2" style="background-color: #ffffff;width: 50%;">
                    <div id="imgRot" style="height: 100%">
                        <table cellpadding="1" cellspacing="1" style="height: 100%" class="tab2">
                            ...
                            <tr>
                                <td style="background-color: #cccccc" align="right">
                                    <asp:Label ID="Label9" runat="server" Text="不透明度：" meta:resourcekey="Label9Resource1"></asp:Label>
                                </td>
                                <td>
            ...
            <tr>
                <td style="background-color: #cccccc; padding-top: 5px; padding-bottom: 5px;" colspan="3">
                    <asp:Label ID="Label16" runat="server" Text="設定文件資訊浮水印" meta:resourcekey="Label16Resource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffffff; padding: 5px;" colspan="3">
                    <asp:Label ID="Label17" runat="server" Text="第1列 : " meta:resourcekey="Label17Resource1"></asp:Label>
                    ...
                    <br />
                    <asp:Label ID="Label18" runat="server" Text="第2列 : " meta:resourcekey="Label18Resource1"></asp:Label>
                    ...
                    <br />
                    <asp:Label ID="Label19" runat="server" Text="第3列 : " meta:resourcekey="Label19Resource1"></asp:Label>
                    ...
                    <br />
                    <asp:Label ID="Label20" runat="server" Text="最多可設定3列浮水印顯示資訊，EX.文件編號、文件名稱、系統日期和文件路徑等。" style="color: #0000ff" meta:resourcekey="Label20Resource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="background-color: #ffffff; padding: 5px;" colspan="3">
                    <asp:Label ID="Label21" runat="server" Text="文件資訊浮水印顯示位置 : " meta:resourcekey="Label21Resource1"></asp:Label><br />
    ...
    <input id="hidSelectColor" runat="server" value="#0070c0" style="width: 31px" type="hidden" />
    <input id="hidSelectColor2" runat="server" value="#0070c0" style="width: 31px" type="hidden" />
