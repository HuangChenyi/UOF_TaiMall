...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">    
        ...
        <WizardSteps>
            ...
            <asp:WizardStep ID="WizardStep1" runat="server" Title="權限設定" meta:resourcekey="WizardStepResource1">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <br />
                        &nbsp;<asp:Label ID="Label48" runat="server" ForeColor="Blue" Text="*簡易審核的文件審核者會套用目前所設定的目錄管理者" meta:resourcekey="labShowHintForFolderManagerResource1"></asp:Label>
            ...
            <asp:WizardStep ID="WizardStep3" runat="server" Title="浮水印設定與封面" meta:resourcekey="WizardStepResource5">                                      
                ...
                <telerik:RadMultiPage ID="RadMultiPageWaterAndCover" runat="server" SelectedIndex="0">
                                ...
                                <table cellpadding="1" cellspacing="1" style="height: 100%; border: #ffffff solid 1px">
                                    ...
                                    <tr>
                                        <td align="right" bgcolor="#cccccc" style="height: 25px; border: #ffffff solid 1px">
                                            <asp:Label ID="Label14" runat="server" Text="不透明度："
                                ...
                                <table cellpadding="1" cellspacing="1" style="height: 100%; border: #999999 solid 1px">
                                    ...
                                    <tr style="border: #ffffff solid 1px">
                                        <td align="right" bgcolor="#cccccc" style="height: 25px">
                                            <asp:Label ID="Label15" runat="server" Text="不透明度："
                        ...
                        <td bgcolor="#ffffff" style="height: 148px; width: 50%;">
                            <div id="imgRot">
                                <table style="border: #999999 solid 1px;">
                                    ...
                                    <tr style="border: #999999 solid 1px">
                                        <td align="right" bgcolor="#cccccc" style="width: 90px; border: 1px solid #ffffff">
                                            <asp:Label ID="Label36" runat="server" Text="不透明度：" meta:resourceKey="Label36Resource1"></asp:Label>
                                        </td>
                                        <td style="width: 158px; border: 1px solid #ffffff">
                    ...
                    <tr style="border: #999999 solid 1px">
                        <td style="background-color: #ffffff; padding: 5px;" colspan="3">
                            <asp:Label ID="Label42" runat="server" Text="設定文件資訊浮水印" meta:resourcekey="Label42Resource1"></asp:Label>
                            <br />
                            <asp:Label ID="Label43" runat="server" Text="第1列 : " meta:resourcekey="Label43Resource1"></asp:Label>
                            <asp:Button ID="btnSetting1" runat="server" Text="設定" Style="margin-bottom: 5px;" OnClientClick="return btnSetting1_Click(this)"/>
                            <asp:Label ID="lblSetting1" runat="server" Text="" style="color: #003D79;"></asp:Label>
                            <br />
                            <asp:Label ID="Label44" runat="server" Text="第2列 : " meta:resourcekey="Label44Resource1"></asp:Label>
                            <asp:Button ID="btnSetting2" runat="server" Text="設定" Style="margin-bottom: 5px;" OnClientClick="return btnSetting2_Click(this)"/>
                            <asp:Label ID="lblSetting2" runat="server" Text="" style="color: #003D79;"></asp:Label>
                            <br />
                            <asp:Label ID="Label45" runat="server" Text="第3列 : " meta:resourcekey="Label45Resource1"></asp:Label>
                            <asp:Button ID="btnSetting3" runat="server" Text="設定" Style="margin-bottom: 5px;" OnClientClick="return btnSetting3_Click(this)"/>
                            <asp:Label ID="lblSetting3" runat="server" Text="" style="color: #003D79;"></asp:Label>
                            <br />
                            <asp:Label ID="Label46" runat="server" Text="最多可設定3列浮水印顯示資訊" style="color: #0000ff" meta:resourcekey="Label46Resource1"></asp:Label>
                        </td>
                    </tr>
                    <tr style="border: 1px ridge #fff;">
                        <td style="background-color: #ffffff; padding: 5px;" colspan="3">
                            <asp:Label ID="Label47" runat="server" Text="文件資訊浮水印顯示位置 : " meta:resourcekey="Label47Resource1"></asp:Label><br />
                            <asp:RadioButtonList ID="rdoInfoPosition" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="PosLeftUp" meta:resourcekey="ListItemResourceTop" Text="左上角"></asp:ListItem>
                                <asp:ListItem Value="PosLeftDown" meta:resourcekey="ListItemResourceBottom" Text="左下角"  Selected="True"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
    ...
    <asp:HiddenField ID="hidSelectColor" runat="server" Value="#0070c0" />    
    <asp:HiddenField ID="hidSelectColor2" runat="server" Value="#0070c0" />
    ...
    <asp:Label ID="lblSetSysInfoTitle" runat="server" Text="設定文件浮水印資訊" Visible="False" meta:resourcekey="lblSetSysInfoTitleResource1"></asp:Label>
    <asp:Label ID="lblBtnSetting" runat="server" Text="設定" Visible="False" meta:resourcekey="lblBtnSettingResource1"></asp:Label>
    ...
    <asp:HiddenField ID="hfSetting1" runat="server" />
    <asp:HiddenField ID="hfSetting2" runat="server" />
    <asp:HiddenField ID="hfSetting3" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function OpenPreview(orientation) {            
            ...
            var hfSetting1 = $("#<%=hfSetting1.ClientID%>").val();          
            var hfSetting2 = $("#<%=hfSetting2.ClientID%>").val();          
            var hfSetting3 = $("#<%=hfSetting3.ClientID%>").val();          

            var documentInfo = {
                sysPdfInfo: {
                    firstLine: hfSetting1,
                    secondLine: hfSetting2,
                    thirdLine: hfSetting3
                }
            };

            var pdfInfo = JSON.stringify(documentInfo, null, 4);
            ...
            var para = JSON.stringify({
                ...
                PdfSysInfo: pdfInfo,
                PdfSysInfoPosition: $("#<%:rdoInfoPosition.ClientID%> input:checked").val()
            });            
    ...
    <script id="FolderSecurityjs" type="text/javascript">
        ...
        function InheritMacrocosmWater(ChangeToPDF) {
            ...
            //2024/10/30 Alvan 加入設定文件資訊浮水印
            var btnSetting1 = $("#<%=btnSetting1.ClientID%>");
            var btnSetting2 = $("#<%=btnSetting2.ClientID%>");
            var btnSetting3 = $("#<%=btnSetting3.ClientID%>");

            //2024/10/30 Alvan 加入文件資訊浮水印顯示位置 
            var rdoInfoPosition = $("#<%=rdoInfoPosition.ClientID%> input[type='radio']");
            ...
            if (cbInheritParentWater.length > 0) {
                if (PDF) {
                    ...
                    //2024/10/30 Alvan 加入設定文件資訊浮水印
                    if (btnSetting1.length > 0) {
                        btnSetting1.prop("disabled", true);
                    }
                    if (btnSetting2.length > 0) {
                        btnSetting2.prop("disabled", true);
                    }
                    if (btnSetting3.length > 0) {
                        btnSetting3.prop("disabled", true);
                    }

                    //2024/10/30 Alvan 加入文件資訊浮水印顯示位置 
                    rdoInfoPosition.prop("disabled", true);
                }
                else {
                    if (folderID == "DMSRoot") {
                        cbInheritParentWater.prop("disabled", true);
        ...
        //設定文件資訊浮水印
        function btnSetting1_Click(sender) {
            let waterMarkSetting = $("#<%=hfSetting1.ClientID %>").val();
            $uof.dialog.open2("~/DMS/Admin/SetDocInfoWatermark.aspx", sender, '<%=lblSetSysInfoTitle.Text%>', 565, 620, openDialogResult, { watermarkSetting: waterMarkSetting, settingRow: "1"});
            return false;
        }

        function btnSetting2_Click(sender) {
            let waterMarkSetting = $("#<%=hfSetting2.ClientID %>").val();
            $uof.dialog.open2("~/DMS/Admin/SetDocInfoWatermark.aspx", sender, '<%=lblSetSysInfoTitle.Text%>', 565, 620, openDialogResult, { watermarkSetting: waterMarkSetting, settingRow: "2"});
            return false;
        }

        function btnSetting3_Click(sender) {
            let waterMarkSetting = $("#<%=hfSetting3.ClientID %>").val();
            $uof.dialog.open2("~/DMS/Admin/SetDocInfoWatermark.aspx", sender, '<%=lblSetSysInfoTitle.Text%>', 565, 620, openDialogResult, { watermarkSetting: waterMarkSetting, settingRow: "3"});
            return false;
        }
