        ...
        <asp:Panel ID="Panel_ad" runat="server" meta:resourcekey="Panel_adResource1">
            <tr>
                ...
                <td >
                    ...
                    <br />
                    <asp:Label ID="lblDomainMsg" runat="server" CssClass="SizeMemo" Text="將網域變更為UOF後，UOF密碼會被清空"
                        meta:resourcekey="lblDomainMsgResource1"></asp:Label>
                </td>
                <td ></td>
                <td ></td>
            </tr>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
    ...
    <asp:Label ID="lblLockLog" runat="server" Text="鎖定" Visible="False" meta:resourcekey="lblLockLogResource1"></asp:Label>
    <asp:Label ID="lblUnLockLog" runat="server" Text="解除鎖定" Visible="False" meta:resourcekey="lblUnLockLogResource1"></asp:Label>
    <asp:Label ID="lblLockLogContent" runat="server" Text="admin此帳號，由({0}){3}於{1}，時間:{2}" Visible="False" meta:resourcekey="lblLockLogContentResource1"></asp:Label>
</asp:Content>
