...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript"> 
        ...
        function AutoLogoutSettingChanging(sender, args) {
            if (args.get_newValue() == "" || isNaN(args.get_newValue())) {
                args.set_newValue(1);
            }
        }
        ...
        function CheckLogoutTime(sender, args) {
            var time = $('#<%= RadNumAutoLogoutTime.ClientID%>').val();
            var ddlTimeType = $("#<%=ddlTimeType.ClientID %>").val();
            if (ddlTimeType == 'minute') {
                if (time < 10) {
                    args.IsValid = false;
                    $('#<%= RadNumAutoLogoutTime.ClientID%>').focus();
                    var toolBar = $find("<%= RadToolBarBasicSet.ClientID %>");
                    var toolbarbutton = toolBar.findItemByValue("Msg")
                    toolbarbutton.set_visible(false);
                }
            }
        }

        function CheckcbEnableWKFDateRangeHaveOne(sender, args) {
            var cbEnableWKFDateRange = $("#<%=cbEnableWKFDateRange.ClientID%>");
            if (cbEnableWKFDateRange != null) {
                if (cbEnableWKFDateRange[0].checked) {
                    //確認底下是否有一個被勾選
                    var cbWKFDateRangeToday = $("#<%=cbWKFDateRangeToday.ClientID%>");
                    var cbWKFDateRangeOneWeek = $("#<%=cbWKFDateRangeOneWeek.ClientID%>");
                    var cbWKFDateRangeTwoWeek = $("#<%=cbWKFDateRangeTwoWeek.ClientID%>");
                    var cbWKFDateRangeOneMonth = $("#<%=cbWKFDateRangeOneMonth.ClientID%>");
                    //確認是否有一個被勾選
                    if (cbWKFDateRangeToday[0].checked || cbWKFDateRangeOneWeek[0].checked || cbWKFDateRangeTwoWeek[0].checked || cbWKFDateRangeOneMonth[0].checked) {
                        args.IsValid = true;
                    }
                    else {
                        args.IsValid = false;
        ...
        function CheckcbEnableTornadoDateRangeHaveOne(sender, args) {
            var cbEnableTornadoDateRange = $("#<%=cbEnableTornadoDateRange.ClientID%>");
            if (cbEnableTornadoDateRange != null) {
                if (cbEnableTornadoDateRange[0].checked) {
                    //確認底下是否有一個被勾選
                    var cbTornadoDateRangeToday = $("#<%=cbTornadoDateRangeToday.ClientID%>");
                    var cbTornadoDateRangeOneWeek = $("#<%=cbTornadoDateRangeOneWeek.ClientID%>");
                    var cbTornadoDateRangeOneMonth = $("#<%=cbTornadoDateRangeOneMonth.ClientID%>");
                    var cbTornadoDateRangeOneYear = $("#<%=cbTornadoDateRangeOneYear.ClientID%>");
                    //確認是否有一個被勾選
                    if (cbTornadoDateRangeToday[0].checked || cbTornadoDateRangeOneWeek[0].checked || cbTornadoDateRangeOneMonth[0].checked || cbTornadoDateRangeOneYear[0].checked) {
                        args.IsValid = true;
                    }
                    else {
                        args.IsValid = false;
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" meta:resourcekey="RadMultiPage1Resource1">
                ...
                <telerik:RadPageView ID="BasicSet" runat="server" meta:resourcekey="BasicSetResource1">
                    ...
                    <table border="0" class="PopTable" style="width: 100%">
                        ...
                        <tr>
                            <td style="width: 13%; word-break: break-all; white-space: nowrap" class="PopTableLeftTD">
                                <asp:Label ID="lblAutoLogoutTimeSetting" runat="server" Text="自動登出時間" meta:resourcekey="lblAutoLogoutTimeSettingResource1"></asp:Label>
                            </td>
                            <td style="width: 87%; word-break: break-all; vertical-align: top;" class="PopTableRightTD">
                                <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <telerik:RadNumericTextBox ID="RadNumAutoLogoutTime" MaxLength="3" MinValue="1" runat="server" DataType="System.Int"
                                            DbValueFactor="1" LabelCssClass="" LabelWidth="64px" Height="23px" Width="50px"
                                            meta:resourcekey="RadNumUChatKeepFileDayResource1" Culture="zh-TW">
                                            <NegativeStyle Resize="None" />
                                            <NumberFormat DecimalDigits="0" ZeroPattern="n" />
                                            <ClientEvents OnValueChanging="AutoLogoutSettingChanging" />
                                            <EmptyMessageStyle Resize="None" />
                                            <ReadOnlyStyle Resize="None" />
                                            <FocusedStyle Resize="None" />
                                            <DisabledStyle Resize="None" />
                                        ...
                                        <asp:DropDownList ID="ddlTimeType" runat="server" Width="60px" Height="23px" AutoPostBack="True" meta:resourcekey="ddlTimeTypeResource1">
                                            <asp:ListItem Value="minute" meta:resourcekey="ListItemResource3" Text="分鐘"></asp:ListItem>
                                            <asp:ListItem Value="hour" meta:resourcekey="ListItemResource4" Text="小時"></asp:ListItem>
                                            <asp:ListItem Value="day" meta:resourcekey="ListItemResource5" Text="天"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:Label ID="lblAutoLogoutTimeRangeMemo" runat="server" Text="*輸入範圍為1~999" CssClass="SizeMemo" meta:resourcekey="lblAutoLogoutTimeRangeMemoResource1"></asp:Label>
                                        <br />
                                        <asp:Label ID="lblAutoLogoutTimeSettingMemo" runat="server" Text="最少需設定10分鐘；當使用者於設定時間內未使用App時，會自動將使用者登出。" CssClass="SizeMemo" meta:resourcekey="lblAutoLogoutTimeSettingMemoResource1"></asp:Label>
                                        <asp:CustomValidator ID="cvCheckTime" runat="server" ErrorMessage="登出時間需大於10分鐘" Display="Dynamic" ClientValidationFunction="CheckLogoutTime" meta:resourcekey="cvCheckTimeResource1"></asp:CustomValidator>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                ...
                <telerik:RadPageView ID="ModuleSet" runat="server" meta:resourcekey="ModuleSetResource1">
                    ...
                    <table border="0" class="PopTable" style="width: 100%">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td style="text-align: left">
                                            <asp:Label ID="lblRange" runat="server" Text="顯示範圍" meta:resourcekey="lblRangeResource1"></asp:Label>
                                            <br />
                                            ...
                                            <asp:Label ID="lblAPPTasksOrder" runat="server" Text="顯示順序" meta:resourcekey="lblAPPTasksOrderResource1"></asp:Label>
                                            <br />
                        ...
                        <tr>
                            <td style="width: 13%; word-break: break-all; white-space: nowrap" class="PopTableLeftTD">
                                <asp:Label ID="lblAPPWKFFilterDataRange" runat="server" Text="限制進階篩選時間範圍" meta:resourcekey="lblAPPFilterDateRangeResource1"></asp:Label>
                            </td>
                            <td style="width: 90%; word-break: break-all" class="PopTableRightTD" colspan="3">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="text-align: left">
                                            <asp:CheckBox ID="cbEnableWKFDateRange" runat="server" meta:resourcekey="cbEnableWKFDateRangeResource1" OnCheckedChanged="cbEnableWKFDateRange_CheckedChanged" AutoPostBack="True" />
                                            <asp:Label ID="Label2" runat="server" meta:resourcekey="lblEnableDateRangeResource1" Text="啟用"></asp:Label>
                                            <asp:CustomValidator ID="CustomValidatorWKFDateRange" ClientValidationFunction="CheckcbEnableWKFDateRangeHaveOne" ForeColor="Red" Display="Dynamic" ErrorMessage="至少需選取一個項目"
                                                runat="server" meta:resourcekey="cvEnableWKFDateRangeResource1"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="tdWKFDateRange" style="padding-left: 20px; padding-bottom: 5px">
                                            <asp:CheckBox ID="cbWKFDateRangeToday" runat="server" Text="今天" meta:resourcekey="cbWKFDateRangeTodayResource1" /><br />
                                            <asp:CheckBox ID="cbWKFDateRangeOneWeek" runat="server" Text="過去一週" meta:resourcekey="cbWKFDateRangeOneWeekResource1" /><br />
                                            <asp:CheckBox ID="cbWKFDateRangeTwoWeek" runat="server" Text="過去兩週" meta:resourcekey="cbWKFDateRangeTwoWeekResource1" /><br />
                                            <asp:CheckBox ID="cbWKFDateRangeOneMonth" runat="server" Text="過去一個月" meta:resourcekey="cbWKFDateRangeOneMonthResource1" /><br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10%; white-space: nowrap; text-align: left;">
                                            <asp:Label ID="lblWKFDateRangeInfo" runat="server" Text="啟用後，電子表單中[已送審]、[已簽核]和[知會]可選擇的時間範圍項目會以此限制為主" meta:resourcekey="lblWKFDateRangeInfoResource1" ForeColor="Blue"></asp:Label>
                                       </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td style="width: 10%; white-space: nowrap; text-align: left;">
                                            ...
                                            <br>
                                            <asp:Label ID="lblAppEventBoardInfo2" runat="server" Text="2.啟用後，App個人首頁會顯示活動看板面板並輪流播放設定的圖片。" meta:resourcekey="lblAppEventBoardInfo2Resource1" ForeColor="Blue"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td colspan="2" class="PopTableHeader" style="text-align: left">
                                <asp:Label ID="lblTornado" runat="server" Text="龍捲風搜尋" meta:resourcekey="lblTornadoResource1"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 13%; word-break: break-all; white-space: nowrap" class="PopTableLeftTD">
                                <asp:Label ID="lblAPPTornadoFilterDataRange" runat="server" Text="限制進階篩選時間範圍" meta:resourcekey="lblAPPFilterDateRangeResource1"></asp:Label>
                            </td>
                            <td style="width: 90%; word-break: break-all" class="PopTableRightTD" colspan="3">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="text-align: left">
                                            <asp:CheckBox ID="cbEnableTornadoDateRange" runat="server" meta:resourcekey="cbEnableTornadoDateRangeResource1" OnCheckedChanged="cbEnableTornadoDateRange_CheckedChanged" AutoPostBack="True" />
                                            <asp:Label ID="Label4" runat="server" meta:resourcekey="lblEnableDateRangeResource1" Text="啟用"></asp:Label>
                                            <asp:CustomValidator ID="CustomValidatorTornadoDateRange" ClientValidationFunction="CheckcbEnableTornadoDateRangeHaveOne" ForeColor="Red" Display="Dynamic" ErrorMessage="至少需選取一個項目"
                                                runat="server" meta:resourcekey="cvEnableTornadoDateRangeResource1"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="tdTornadoDateRange" style="padding-left: 20px; padding-bottom: 5px">
                                            <asp:CheckBox ID="cbTornadoDateRangeToday" runat="server" Text="過去一天" meta:resourcekey="cbTornadoDateRangeTodayResource1" /><br />
                                            <asp:CheckBox ID="cbTornadoDateRangeOneWeek" runat="server" Text="過去一週" meta:resourcekey="cbTornadoDateRangeOneWeekResource1" /><br />
                                            <asp:CheckBox ID="cbTornadoDateRangeOneMonth" runat="server" Text="過去一個月" meta:resourcekey="cbTornadoDateRangeOneMonthResource1" /><br />
                                            <asp:CheckBox ID="cbTornadoDateRangeOneYear" runat="server" Text="過去一年" meta:resourcekey="cbTornadoDateRangeOneYearResource1" /><br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10%; white-space: nowrap; text-align: left;">
                                            <asp:Label ID="lblTornadoDateRangeInfo" runat="server" Text="啟用後，[龍捲風搜尋]可選擇的時間範圍項目會以此限制為主" meta:resourcekey="lblTornadoDateRangeInfoResource1" ForeColor="Blue"></asp:Label>
                                       </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td style="width: 87%; word-break: break-all" class="PopTableRightTD">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:Label ID="lbl104PayEnvelopeErrorMessage" runat="server" ForeColor="Red" Visible="False" meta:resourcekey="lbl104PayEnvelopeErrorMessageResource1" Text="無法使用104電子薪資袋"></asp:Label>
                                        <br />
