...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function rbtnSetConnParam_Clicking(sender, args) {
            ...
            let txbPwd0 = $("#<%= txbPwd0.ClientID %>").val();
            let hfSmtpPassword = $("#<%= hfSmtpPassword.ClientID %>").val();
            let isNeedDecrypt = txbPwd0 === '*****' ? true : false;

            var smtpServer = $("#<%= txbSmtp.ClientID %>").val();
            var smtpPort = $("#<%= txbPort.ClientID %>").val();
            var smtpAccount = $("#<%= txbAccount.ClientID %>").val();
            var SmtpPwd = txbPwd0 === '*****' ? hfSmtpPassword : txbPwd0;
            ...
            $uof.dialog.open2("~/System/Config/SmtpConn.aspx", args, "", 600, 450, SetConnDialogResult,
                { "SmtpServer": smtpServer, "SmtpPort": smtpPort, "SmtpAccount": smtpAccount, "SmtpPwd": SmtpPwd, "Sender": Sender, "SSL": ssl, "isNeedDecrypt": isNeedDecrypt });
        }
    ...
    <asp:UpdatePanel ID="UpdatePaneGO" runat="server">
        <ContentTemplate>
            ...
            <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0"
                    ...
                    <table border="0" class="PopTable" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 87%; word-break: break-all" class="PopTableRightTD">
                                ...
                                <asp:CustomValidator ID="cvSenderEmailFormat" runat="server" OnServerValidate="cvSenderEmailFormat_ServerValidate"
                                    Display="Dynamic" ErrorMessage="請輸入正確的Email格式" meta:resourcekey="RegularExpressionValidator1Resource1"></asp:CustomValidator>
                                <br />
                        ...
                        <tr>
                            ...
                            <td style="width: 87%; word-break: break-all" class="PopTableRightTD">
                                ...
                                <asp:CustomValidator ID="cvAdminEmailFormat" runat="server" OnServerValidate="cvAdminEmailFormat_ServerValidate"
                                    Display="Dynamic" ErrorMessage="請輸入正確的Email格式" meta:resourcekey="RegularExpressionValidator1Resource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                ...
                <telerik:RadPageView ID="loginSet" runat="server" meta:resourcekey="loginSetResource1">
                    ...
                    <table border="0" style="width: 100%" class="PopTable">
                                                    ...
                                                    <tr style="vertical-align: top">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txbIPEnd" runat="server" Columns="15" MaxLength="15" Text='<%# Eval("END") %>'
                                                                meta:resourcekey="txbIPEndResource1">
                                                            </asp:TextBox>
                                                            ...
                                                            <asp:CustomValidator ID="cvRangeCheck" runat="server" Display="Dynamic" EnableClientScript="False"
                        ...
                        <tr>
                            <td style="width: 13%; word-break: break-all; white-space: nowrap" class="PopTableLeftTD">
                                <asp:Label ID="lblIsCaptcha" runat="server" Text="登入圖形驗證碼" meta:resourcekey="lblIsCaptchaResource1"></asp:Label>
                                </td>
                            <td style="width: 87%; word-break: break-all" class="PopTableRightTD">
                                <asp:CheckBox ID="cbEnableCaptcha" runat="server"  Text="啟用"
                                    meta:resourcekey="cbEnableCaptchaResource1"  />
                                </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="PopTableHeader" style="text-align: left">
                ...
                <telerik:RadPageView ID="moduleSet" runat="server"
                    ...
                    <table border="0" class="PopTable" style="width: 100%">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:Label ID="lblDMSConvertLimitInfo1" CssClass="SizeMemo" runat="server" Text="*支援以下格式(doc,docx,txt,ppt,pptx,xls,xlsx,jpg,jpeg,png,bmp,gif,pdf,ods,odt,odp)" meta:resourcekey="lblDMSConvertLimitInfo1Resource1"></asp:Label>
                                            <br />
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <br />
                                            <asp:Label ID="lblDMSConvertLimitInfo5" CssClass="SizeMemo" runat="server" Text="*當各格式的文件轉為PDF檔的頁數超過上限時，會停止該文件的轉檔作業。" meta:resourcekey="lblDMSConvertLimitInfo5Resource1"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td class="PopTableLeftTD" style="width: 13%; word-break: break-all; white-space: nowrap">
                                <asp:Label ID="Label109" runat="server" ForeColor="Red"
                                    meta:resourcekey="Label09Resource1" Text="*"></asp:Label>
                                <asp:Label ID="Label110" runat="server" meta:resourcekey="Label110Resource1"
                                    Text="允許上傳檔案大小"></asp:Label>
                            </td>
                            <td class="PopTableRightTD" style="width: 87%; word-break: break-all">
                                 <asp:TextBox ID="txtMaxMovieSize" runat="server" MaxLength="4"
                                     meta:resourcekey="txtMaxMovieSizeResource1" Width="50px"></asp:TextBox>
                                <asp:Label ID="Label133" runat="server" meta:resourcekey="Label133Resource1"
                                    Text="MB(1~2000MB)"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server"
                                    ControlToValidate="txtMaxMovieSize" Display="Dynamic" ErrorMessage="不允許空白"
                                    meta:resourcekey="RequiredFieldValidator23Resource1" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                <asp:RangeValidator ID="RangeValidator15" runat="server"
                                    ControlToValidate="txtMaxMovieSize" Display="Dynamic"
                                    ErrorMessage="檔案大小不正確，請重新輸入" MaximumValue="2000"
                                    meta:resourcekey="RangeValidator15Resource1" MinimumValue="1"
                        ...
                        <asp:Panel runat="server" ID="Enable104HRSetting" meta:resourcekey="Enable104HRSettingResource1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="lbl104PayEnvelopeErrorMessage" runat="server" ForeColor="Red" Text="無法使用104電子薪資袋" Visible="false" meta:resourcekey="lbl104PayEnvelopeErrorMessageResource1"></asp:Label>
                                    <br />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="Label178" runat="server" CssClass="SizeMemo" Text="啟用多公司別後，會清空根節點的部門代碼，以利將104所有公司的組織架構同步至UOF" meta:resourcekey="Label178Resource1"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label135" runat="server" Text="表單起結案異常通知" meta:resourcekey="Label135Resource1"></asp:Label>
                                </td>
                                <td>
                                   <asp:CheckBox ID="cbNotifyFailureToApplicant" runat="server" Text="通知申請者" meta:resourcekey="cbNotifyFailureToApplicantResource1" /><br />
                                    <asp:Label ID="lblNotifyFailureToApplicantMemo1" runat="server" Text="1.勾選後，若請假單/出差單/加班單在起單或結案時未成功寫入104，系統會發送異常通知給申請者和代理申請者，可即時找表單管理員處理單據。" ForeColor="Blue" meta:resourcekey="lblNotifyFailureToApplicantMemo1Resource1"></asp:Label><br />
                                    <asp:Label ID="lblNotifyFailureToApplicantMemo2" runat="server" Text="2.「加班單(多時段)/加班單(批次申請)」在起單結案時若驗證失敗，原先就會發送「驗證失敗通知」給申請者及代理申請者，不受此功能設定影響。" ForeColor="Blue" meta:resourcekey="lblNotifyFailureToApplicantMemo2Resource1"></asp:Label>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr>
            ...
            <asp:HiddenField ID="hfSmtpPassword" runat="server" Value="" />
            <asp:HiddenField ID="hfAiraPassword" runat="server" Value="" />
