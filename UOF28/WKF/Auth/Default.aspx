    ...
    <script type="text/javascript">
        function OnToolbarClicking(e, args) {
            ...
            if (Key == "new") {
                ...
                let confirmMessage = '';
                if (roleId == "WKFClassifiedDesigner")
                    confirmMessage = '<%=lblConfirmDeleteDesigner.Text %>'
                else if (roleId == "WKFClassifiedHandOver")
                    confirmMessage = '<%=lblConfirmDeleteHandOver.Text %>'
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td valign="top">
                        ...
                        <asp:Label ID="lblConfirmDeleteDesigner" runat="server" Text="確認要刪除此設計者?" Visible="false" meta:resourcekey="lblConfirmResource1"></asp:Label>
                        <asp:Label ID="lblConfirmDeleteHandOver" runat="server" Text="確認要刪除此交接管理員?" Visible="false" meta:resourcekey="lblConfirmResource2"></asp:Label>
                    </td>
                </tr>
            </table>
        </ContentTemplate>
