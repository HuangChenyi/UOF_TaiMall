<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/MobileMasterPage.master"  CodeBehind="OtherSiteSendPreview.aspx.cs" Inherits="Ede.Uof.Web.WKF.FormUse.Mobile.OtherSiteSendPreview" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                                                ...
                                                <Rows>
                                                    ...
                                                    <telerik:LayoutRow ID="PanelNextSite" runat="server">
                                                        <Columns>
                                                            ...
                                                            <telerik:LayoutColumn Span="12">
                                                                <uc1:UC_ChoiceListMobile runat="server" ID="UC_ChoiceListMobile" Visible="false" IsAllowEdit="false"/>
                                                    ...
                                                    <telerik:LayoutRow>
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12">
                                                                ...
                                                                <asp:CustomValidator ID="CustomValidatorAssignSite" runat="server" Display="Dynamic" EnableTheming="true"
