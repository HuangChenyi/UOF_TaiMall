<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="OtherSiteSendPreview.aspx.cs" Inherits="OtherSiteSendPreview" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr>
            ...
            <td>
                <asp:Panel ID="panelMasterSelect" runat="server" Width="100%" meta:resourcekey="panelMasterSelectResource1">
                    <asp:RadioButtonList ID="rblMasterFlow" runat="server" RepeatDirection="Horizontal"
                        OnSelectedIndexChanged="rblMasterFlow_SelectedIndexChanged" AutoPostBack="True" Enabled="false"
            ...
            <td>
                <asp:Panel ID="panelSubSelect" runat="server" Width="100%" meta:resourcekey="panelSubSelectResource1">
                    <asp:RadioButtonList ID="rblSubFlow" runat="server" RepeatDirection="Horizontal" Enabled="false"
        ...
        <asp:Panel ID="PanelNextSite" runat="server" Width="100%" meta:resourcekey="PanelNextSiteResource1"
            ...
            <tr>
                ...
                <td style="white-space:nowrap">
                    <asp:RadioButtonList ID="rblSignType" runat="server" RepeatDirection="Horizontal" Enabled="false"
                ...
                <td valign="middle">
                    <telerik:RadNumericTextBox ID="tbTimeoutCount" Enabled="false" runat="server" Width="60px" MinValue="0" Value="0" DataType="System.String" Culture="zh-TW" DbValueFactor="1" LabelCssClass="" LabelWidth="64px" meta:resourcekey="tbTimeoutCountResource2">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadNumericTextBox ID="txtCycleAlert" Enabled="false" runat="server" Width="60px" MinValue="0" Value="0" DataType="System.String" Culture="zh-TW" DbValueFactor="1" LabelCssClass="" LabelWidth="64px" meta:resourcekey="txtCycleAlertResource1">
                        <NegativeStyle Resize="None" />
                        <NumberFormat ZeroPattern="n" AllowRounding="False" DecimalDigits="0"  ></NumberFormat>
                        <EmptyMessageStyle Resize="None" />
                        <ReadOnlyStyle Resize="None" />
                    ...
                    <asp:Label ID="Label7" runat="server" Text="[0表示不提醒]" CssClass="SizeMemo" meta:resourcekey="Label7Resource1"></asp:Label>
                ...
                <td>
                    <telerik:RadNumericTextBox ID="txtAutoSign" Enabled="false" runat="server" Width="60px" MinValue="0" Value="0" DataType="System.String" Culture="zh-TW" DbValueFactor="1" LabelCssClass="" LabelWidth="64px" meta:resourcekey="txtAutoSignResource1">
                        <NegativeStyle Resize="None" />
                        <NumberFormat ZeroPattern="n" AllowRounding="False" DecimalDigits="0"  ></NumberFormat>
                        <EmptyMessageStyle Resize="None" />
                        <ReadOnlyStyle Resize="None" />
    ...
    <div style="display: none">
        ...
        <asp:RadioButtonList ID="rblSignResult" runat="server" RepeatDirection="Horizontal" Enabled="false"
    ...
    <asp:CustomValidator ID="CustomValidatorCustSite" runat="server" Display="Dynamic"
        ErrorMessage="下一站為自訂流程站點，不支援快速簽核" meta:resourcekey="CustomValidatorCustSiteResource1"></asp:CustomValidator>
    <asp:CustomValidator ID="CustomValidatorGroupSite" runat="server" Display="Dynamic"
        ErrorMessage="下一站為自選流程站點，不支援快速簽核" meta:resourcekey="CustomValidatorGroupSiteResource1"></asp:CustomValidator>
    <asp:CustomValidator ID="CustomValidatorAssignSite" runat="server" Display="Dynamic"
        ErrorMessage="下一站為[指定式站點]，不支援快速簽核" meta:resourcekey="CustomValidatorAssignSiteResource1"></asp:CustomValidator>
