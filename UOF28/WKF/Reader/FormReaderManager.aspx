...
<%@ Register Src="~/Common/ChoiceCenter/UC_BtnChoiceOnce.ascx" TagPrefix="uc3" TagName="UC_BtnChoiceOnce" %>
...
<style type="text/css">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <td>
                                                    <table class="PopTable" cellspacing="1">
                                                        ...
                                                        <tr>
                                                            <td class="PopTableLeftTD" nowrap="nowrap" align="right">
                                                                <asp:Label ID="Label3" runat="server" Text="申請者：" meta:resourcekey="Label3Resource1"></asp:Label></td>
                                                            <td class="PopTableRightTD" nowrap="nowrap" colspan="3">
                                                        ...
                                                        <tr>
                                                            <td class="PopTableLeftTD" nowrap="nowrap" align="right">
                                                                <asp:Label ID="Label12" runat="server" Text="申請者部門：" meta:resourcekey="Label12Resource1"></asp:Label></td>
                                                            <td class="PopTableRightTD" nowrap="nowrap" colspan="3">
                                                                <uc3:UC_BtnChoiceOnce ID="ucBtnChoiceOnce" runat="server"/>
                                                                <asp:Label ID="lblApplicantDep" runat="server" Text="選擇部門" Visible="false" meta:resourcekey="lblApplicantDepResource1"></asp:Label>
                                                                <telerik:RadButton ID="rbtnClear" runat="server" Text="清除" OnClick="rbtnClear_Click" meta:resourcekey="rbtnClearResource1"></telerik:RadButton>
                                                                <asp:Image ID="imgUserGroup" runat="server" />
                                                                <asp:Label ID="lblUserGroup" runat="server"></asp:Label>
                                                                <asp:HiddenField ID="hfUserGroup" runat="server" />
                                                        </tr>
                                                        <tr>
                                                            <td nowrap="nowrap" align="right" width="20%" class="PopTableLeftTD">
                                                        ...
                                                        <tr>
                                                            <td nowrap="nowrap" align="right" width="20%" class="PopTableLeftTD">
                                                                <asp:Label ID="lbl_SignJobTitle" runat="server" Text="簽核者職級：" meta:resourcekey="lbl_SignJobTitleResource1"></asp:Label>
                                                            </td>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <Fast:Grid ID="DGDraftList" runat="server" Width="100%" PageSize="15" EnhancePager="True" DataKeyOnClientWithCheckBox="False" AllowPaging="True" CustomDropDownListPage="True" AutoGenerateCheckBoxColumn="False" AllowSorting="True" OnPageIndexChanging="DGDraftList_PageIndexChanging" AutoGenerateColumns="False" OnRowDataBound="DGDraftList_RowDataBound" OnSorting="DGDraftList_Sorting" DataKeyNames="TASK_ID" DefaultSortDirection="Ascending" OnBeforeExport="DGDraftList_BeforeExport" EmptyDataText="No data found" KeepSelectedRows="False" meta:resourcekey="DGDraftListResource2" SelectedRowColor="" UnSelectedRowColor="">
                                                        ...
                                                        <ExportExcelSettings AllowExportToExcel="True" DataSourceType="ObjectDataSource" ExportType="GridContentOld"/>
                                                        <Columns>
    ...
    <asp:HiddenField ID="hfHasPrintAuth" runat="server" />
